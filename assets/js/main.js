/*--------------------------
    Project Name: Abaris Healthcare
    Version: 1.0
    Author: 7oorof
...
$(function () {
  ...
  // 1) Add icon span to each header (once)
  $(".accordion-header").each(function () {
    if (!$(this).find(".acc-icon").length) {
      $(this).append('<span class="acc-icon" aria-hidden="true"></span>');
    }
  });

  // 2) Keep .opened in sync with Bootstrap collapse (preferred over click)
  $("#accordion1 .collapse")
  ...
  // 3) Initialize state on load (for any .show already in DOM)
  $("#accordion1 .collapse.show").each(function () {
